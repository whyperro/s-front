...
const BatchDetailPage = () => {
  ...
  const { mutate, data: articles, isPending: isBatchesLoading, isError } = useGetArticlesByBatch(Number(selectedStation), String(name));
  ...
  return (
    <ContentLayout title='Inventario'>
      <div className='flex flex-col gap-y-2'>
        ...
        <h3 className='text-3xl font-bold italic text-center'>{name.toUpperCase()}</h3>
