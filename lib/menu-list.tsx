  ...
  return (
    company === "transmandu"
      ? [
          ...
          {
            groupLabel: "Admistración - TEST",
            menus: [
              {
                href: "/transmandu/administracion/clientes",
                label: "Gestion de Clientes",
                active: pathname.includes(
                  "/transmandu/administracion/clientes"
                ),
                icon: BookUser,
                roles: [
                  "ADMIN",
              ...
              {
                href: "/transmandu/administracion/rutas",
                label: "Gestion de Rutas",
                active: pathname.includes("/transmandu/administracion/rutas"),
                icon: Route,
                roles: [
                  "ADMIN",
                  "SUPERUSER",
              ...
              {
                href: "/transmandu/administracion/aviones",
                label: "Gestion de Aviones",
                active: pathname.includes("/transmandu/administracion/aviones"),
                icon: PlaneIcon,
                roles: [
                  "ADMIN",
                  "SUPERUSER",
              ...
              {
                href: "/transmandu/administracion/pagos-vuelos",
                label: "Pagos de Vuelos",
